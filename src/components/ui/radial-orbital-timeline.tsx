  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Center hub */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-white rounded-full shadow-[0_0_20px_rgba(255,255,255,0.5)]" />
        ...
        {timelineData.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`absolute top-1/2 left-1/2 h-px bg-gradient-to-r from-white/20 to-transparent origin-left transition-all duration-500 ${
              ...
              <div
                className={`relative w-12 h-12 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${
                  isExpanded
                    ? "scale-125 bg-white text-black border-white"
                    : isRelated
                    ? "scale-110 bg-white/20 text-white border-white/50"
              ...
              {/* Expanded card */}
              {isExpanded && (
                <Card className="absolute left-16 top-1/2 -translate-y-1/2 w-72 bg-black/90 border-white/20 backdrop-blur-lg">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-gradient-to-r from-white/50 to-white rounded-full transition-all duration-500"
